...
PING_SRCS=GameManager.cpp Game.cpp SharedState.cpp ButtonMenu.cpp Textbox.cpp TitleScreen.cpp DifficultyMenu.cpp MultiplayerMenu.cpp DevConsole.cpp ErrorScreen.cpp KeyboardInput.cpp AIInput.cpp Vector2.cpp Entity.cpp Texture.cpp Socket.cpp utility.cpp
